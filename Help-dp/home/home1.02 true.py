...
def main(page: ft.Page):
        ...
        if db_session.query(Property).count() == 0:
            properties = [
                Property(
                    ...
                    image_url="https://placehold.co/600x400/2563eb/white?text=Imóvel+Centro"
                ),
                Property(
    ...
    def show_property_details(property):
        details_view.controls = [
            ...
            ft.Image(src=property.image_url, height=300, width=400, fit=ft.ImageFit.COVER),
            ft.ListTile(
    ...
    home_view = ft.View(
        "/",
        [
            ft.AppBar(title=ft.Text("Imóvel Social")),
